...
SECRET_KEY = '@gkj%%@_%au3%_bwzg)!tmlg4m)b65uhnzk$4dp6j6r@k@pxsi'
...
TEMPLATES = [
    {
        ...
        # Искать шаблоны на уровне проектпа
        'DIRS': [TEMPLATES_DIR],
...
# LOGOUT_REDIRECT_URL = 'posts:index' — и при выходе из аккаунта юзеры направятся на главную
